    ...
    <div className="flex flex-col my-28 items-start gap-12 relative">
      <div className="flex-col items-center gap-14 self-stretch w-full flex relative flex-[0_0_auto]">
        <div className="flex-col  items-center gap-5 flex relative flex-[0_0_auto]">
          <div className="text-[80px] tracking-[-0.80px] relative self-stretch mt-[-1.00px] [font-family:'Lato-Bold',Helvetica] font-bold text-background-500 leading-[normal]">
            Privacy Policy
          </div>

          <p className="relative self-stretch [font-family:'Lato-SemiBold',Helvetica] font-semibold text-background-400 text-2xl text-center tracking-[-0.72px] leading-[normal]">
            Last Update on 1st Feb, 2025
          </p>
        </div>

        <p className="relative self-stretch [font-family:'Lato-Bold',Helvetica] font-bold text-background-300 text-2xl tracking-[0] leading-10">
      ...
      <div className="flex-col items-start gap-6 self-stretch w-full">
        <div className="relative self-stretch mt-[-1.00px] [font-family:'Lato-Bold',Helvetica] font-bold text-background-500 text-[32px] tracking-[-0.32px] leading-[normal]">
        ...
        <div className="flex flex-col gap-6">
          <div>
            <div className="text-2xl tracking-[-0.24px] [font-family:'Lato-Bold',Helvetica] font-bold text-background-500 leading-[normal] mb-3">
              Personal Information
            </div>
            <ul className="list-disc pl-8">
              <li className="[font-family:'Lato-Bold',Helvetica] font-bold text-background-300 text-2xl">
                Name
              </li>
              <li className="[font-family:'Lato-Bold',Helvetica] font-bold text-background-300 text-2xl">
                Email address
      ...
      <div className="flex-col items-start gap-6 self-stretch w-full">
        <div className="relative self-stretch [font-family:'Lato-Bold',Helvetica] font-bold text-background-500 text-[32px] tracking-[-0.32px] leading-[normal]">
      ...
      <div className="flex-col items-start gap-6 self-stretch w-full flex relative flex-[0_0_auto]">
        <div className="flex-col items-start gap-6 self-stretch w-full flex relative flex-[0_0_auto]">
          <p className="relative self-stretch mt-[-1.00px] [font-family:'Lato-Bold',Helvetica] font-bold text-background-500 text-[32px] tracking-[-0.32px] leading-[normal]">
            3. How We Share Your Information
          </p>

          <p className="relative self-stretch [font-family:'Lato-Bold',Helvetica] font-bold text-background-300 text-2xl tracking-[0] leading-8">
        ...
        <div className="flex-col items-start gap-3 self-stretch w-full flex relative flex-[0_0_auto]">
          <div className="text-2xl tracking-[-0.24px] relative self-stretch mt-[-1.00px] [font-family:'Lato-Bold',Helvetica] font-bold text-background-500 leading-[normal]">
            Service Providers
          </div>

          <div className="flex items-center justify-center gap-2.5 relative self-stretch w-full flex-[0_0_auto]">
            <p className="relative flex-1 mt-[-1.00px] [font-family:'Lato-Bold',Helvetica] font-bold text-background-300 text-2xl tracking-[0] leading-8">
        ...
        <div className="flex-col items-start gap-3 self-stretch w-full flex relative flex-[0_0_auto]">
          ...
          <div className="flex items-center justify-center gap-2.5 relative self-stretch w-full flex-[0_0_auto]">
            <p className="relative flex-1 mt-[-1.00px] [font-family:'Lato-Bold',Helvetica] font-bold text-background-300 text-2xl tracking-[0] leading-10">
