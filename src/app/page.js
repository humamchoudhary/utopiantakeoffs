...
const ConstructionTakeOff = dynamic(
    () => import("@/components/ConstructionTakeOff"),
    { ssr: false },
);
const CleintSlider = dynamic(() => import("@/components/ClientSlider"), {
    ssr: false,
});
export default async function Home() {
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <ClientShowcase />
            <EstimatingServices />
            <ConstructionTakeOff services={services} />
            <WhyUs />
            <ServicesSection />
            <WorkWithUs />
            <GetQoute />
        ...
        <div className="px-12 w-full">
            <div className="relative w-full flex flex-col justify-center items-center bg-primary rounded-3xl py-[72px]">
                ...
                <div className="px-5 py-3 mb-5 border border-bg rounded-xl">
                    <p className="text-lg text-bg font-semibold leading-[normal]">Save 30% Now</p>
                </div>
                <p className="text-[#E4E4E4] mx-[340px] font-semibold text-[32px] text-center">Work With Us! We Are A Global Network
                    Of Construction Cost Expert</p>
                <div className="px-[32px] py-4   mb-[100px] bg-bg rounded-xl">
                    <p className="text-lg text-primary font-semibold leading-[normal]">Save 30% Now</p>
                </div>
...
const GetQoute = () => {
    return <div className="mt-[120px] flex flex-col justify-center items-center">
        <div className="w-full px-56" >
            <p className="text-center font-semibold text-xl text-[#601E1A]">How To Begin With Us</p>
            <h1 className="text-center font-semibold text-[40px] text-[#13151B]">How To Begin With Us</h1>
            <p className="text-center text-xl leading-10 text-[#475464]">
                Get precise construction estimates and quantity takeoffs, tailored to your project
                needs, delivered quickly and accurately by our expert team. </p>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" width={253} height={86} fill="none" className="mt-[37px]">
            <path
                fill="#601E1A"
            ...
            <div className="w-full flex flex-col gap-9">
                <div className="flex flex-row gap-8">
                    <div className="flex items-center flex-col">
                        <div className="bg-primary rounded-full px-[25px] py-3 text-[32px] text-bg leading-[normal]" >1</div>
                        <svg xmlns="http://www.w3.org/2000/svg" width={4} height={92} fill="none">
                            <path
                                fill="#601E1A"
                    ...
                    <div className="flex flex-col justify-center gap-[9px]" >
                        <p className="text-2xl font-bold leading-[normal]">Submit Your Drawing Plans</p>
                        <p className="text-xl text-[#475464] leading-9">Submit your PDF drawings, and we'll provide a quote with invoice, turnaround time, and delivery date.</p>
                    </div>
                </div>
                <div className="flex flex-row gap-8">
                    <div className="flex items-center flex-col">
                        <div className="bg-primary rounded-full px-[22px] py-3 text-[32px] text-bg leading-[normal]" >2</div>
                        <svg xmlns="http://www.w3.org/2000/svg" width={4} height={92} fill="none">
                            <path
                                fill="#601E1A"
                                d="M.5 90a1.5 1.5 0 0 0 3 0h-3Zm0-90v2.813h3V0h-3Zm0 8.438v5.624h3V8.439h-3Zm0 11.25v5.625h3v-5.625h-3Zm0 11.25v5.625h3v-5.626h-3Zm0 11.25v5.624h3v-5.624h-3Zm0 11.25v5.624h3v-5.624h-3Zm0 11.25v5.624h3v-5.624h-3Zm0 11.25v5.624h3v-5.624h-3Zm0 11.25V90h3v-2.813h-3Z"
                ...
                <div className="flex flex-row gap-8">
                    <div className="flex items-center flex-col">
                        <div className="bg-primary rounded-full px-[22px] py-3 text-[32px] text-bg leading-[normal]" >3</div>
                        <svg xmlns="http://www.w3.org/2000/svg" width={4} height={92} fill="none">
                            <path
                                fill="#601E1A"
                                d="M.5 90a1.5 1.5 0 0 0 3 0h-3Zm0-90v2.813h3V0h-3Zm0 8.438v5.624h3V8.439h-3Zm0 11.25v5.625h3v-5.625h-3Zm0 11.25v5.625h3v-5.626h-3Zm0 11.25v5.624h3v-5.624h-3Zm0 11.25v5.624h3v-5.624h-3Zm0 11.25v5.624h3v-5.624h-3Zm0 11.25v5.624h3v-5.624h-3Zm0 11.25V90h3v-2.813h-3Z"
                    ...
                    <div className="flex flex-col justify-center gap-[9px]" >
                        <p className="text-2xl font-bold leading-[normal]">Receive Estimate</p>
                        <p className="text-xl text-[#475464] leading-9">You'll receive a detailed estimate with material, labor quantities, and pricing in Excel, using our or your preferred template.</p>
                    </div>
                </div>

            </div>
            <svg xmlns="http://www.w3.org/2000/svg" width={3} height={528} fill="none">
