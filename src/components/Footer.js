...
const Footer = () => {
  return (
    <footer className="w-full rounded-t-[23px] flex flex-col py-1 mt-20 px-1 bg-fg">
      <div className="w-full mt-14 px-10 bg-fg">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center  text-sm text-[#808080]">
          <p>Copyright © 2024 Utopian Takeoffs. All rights reserved</p>
        </div>
      </div>
    </footer>
  );
